...
var NzPopconfirmDirective = class _NzPopconfirmDirective extends NzTooltipBaseDirective {
  ...
  createComponent() {
    ...
    this.component.nzOnCancel.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      this.nzOnCancel.emit();
    });
    this.component.nzOnConfirm.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
...
var NzPopconfirmComponent = class _NzPopconfirmComponent extends NzToolTipComponent {
  constructor(elementRef) {
    ...
    this.nzOnCancel = new import_rxjs.Subject();
    this.nzOnConfirm = new import_rxjs.Subject();
    this._trigger = "click";
  ...
  onConfirm() {
    if (this.nzBeforeConfirm) {
      const observable = wrapIntoObservable(this.nzBeforeConfirm()).pipe((0, import_operators.first)());
      this.confirmLoading = true;
      observable.pipe((0, import_operators.finalize)(() => {
        this.confirmLoading = false;
        this.cdr.markForCheck();
      }), (0, import_operators.takeUntil)(this.nzVisibleChange), (0, import_operators.takeUntil)(this.destroy$)).subscribe((value) => {
        if (value) {
          this.handleConfirm();
        }
      });
