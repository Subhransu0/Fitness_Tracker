...
var NzAnchorComponent = class _NzAnchorComponent {
  ...
  registerScrollEvent() {
    ...
    this.zone.runOutsideAngular(() => {
      (0, import_rxjs.fromEvent)(this.getContainer(), "scroll", passiveEventListenerOptions).pipe((0, import_operators.throttleTime)(50), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => this.handleScroll());
    });
