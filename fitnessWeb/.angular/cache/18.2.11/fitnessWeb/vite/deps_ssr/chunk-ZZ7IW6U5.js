...
var NzTreeBaseService = class _NzTreeBaseService {
  constructor() {
    ...
    this.rootNodes = [];
    this.flattenNodes$ = new import_rxjs.BehaviorSubject([]);
...
var NzTreeNodeBuiltinComponent = class _NzTreeNodeBuiltinComponent {
  ...
  handDragEvent() {
    this.ngZone.runOutsideAngular(() => {
      if (this.nzDraggable) {
        ...
        (0, import_rxjs2.fromEvent)(nativeElement, "dragstart").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((e) => this.handleDragStart(e));
        (0, import_rxjs2.fromEvent)(nativeElement, "dragenter").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((e) => this.handleDragEnter(e));
        (0, import_rxjs2.fromEvent)(nativeElement, "dragover").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((e) => this.handleDragOver(e));
        (0, import_rxjs2.fromEvent)(nativeElement, "dragleave").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((e) => this.handleDragLeave(e));
        (0, import_rxjs2.fromEvent)(nativeElement, "drop").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((e) => this.handleDragDrop(e));
        (0, import_rxjs2.fromEvent)(nativeElement, "dragend").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((e) => this.handleDragEnd(e));
      } else {
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs2.fromEvent)(this.elementRef.nativeElement, "mousedown").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
...
var NzTreeComponent = class _NzTreeComponent extends NzTreeBase {
  ...
  ngOnInit() {
    this.nzTreeService.flattenNodes$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((data) => {
...
//# sourceMappingURL=chunk-ZZ7IW6U5.js.map
