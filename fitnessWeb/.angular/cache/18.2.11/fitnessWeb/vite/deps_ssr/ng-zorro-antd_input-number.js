...
var NzInputNumberComponent = class _NzInputNumberComponent {
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs.fromEvent)(this.inputElement.nativeElement, "keyup").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => this.stop());
      (0, import_rxjs.fromEvent)(this.inputElement.nativeElement, "keydown").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
        const {
          keyCode
        } = event;
  ...
  setupHandlersListeners() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs.merge)((0, import_rxjs.fromEvent)(this.upHandler.nativeElement, "mouseup"), (0, import_rxjs.fromEvent)(this.upHandler.nativeElement, "mouseleave"), (0, import_rxjs.fromEvent)(this.downHandler.nativeElement, "mouseup"), (0, import_rxjs.fromEvent)(this.downHandler.nativeElement, "mouseleave")).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => this.stop());
    });
  }
...
var NzInputNumberGroupComponent = class _NzInputNumberGroupComponent {
  ...
  ngAfterContentInit() {
    ...
    const listOfInputChange$ = this.listOfNzInputNumberComponent.changes.pipe((0, import_operators.startWith)(this.listOfNzInputNumberComponent));
    listOfInputChange$.pipe((0, import_operators.switchMap)((list) => (0, import_rxjs.merge)(...[listOfInputChange$, ...list.map((input) => input.disabled$)])), (0, import_operators.mergeMap)(() => listOfInputChange$), (0, import_operators.map)((list) => list.some((input) => input.nzDisabled)), (0, import_operators.takeUntil)(this.destroy$)).subscribe((disabled) => {
