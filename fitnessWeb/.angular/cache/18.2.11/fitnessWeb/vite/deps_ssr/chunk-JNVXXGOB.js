...
var NzAffixComponent = class _NzAffixComponent {
  ...
  constructor(el, nzConfigService, scrollSrv, ngZone, platform, renderer, nzResizeObserver, cdr, directionality) {
    ...
    this.dir = "ltr";
    this.positionChangeSubscription = import_rxjs.Subscription.EMPTY;
    this.offsetChanged$ = new import_rxjs.ReplaySubject(1);
  ...
  registerListeners() {
    ...
    this.positionChangeSubscription = this.ngZone.runOutsideAngular(() => (0, import_rxjs.merge)(...Object.keys(AffixRespondEvents).map((evName) => (0, import_rxjs.fromEvent)(this.target, evName)), this.offsetChanged$.pipe((0, import_operators.map)(() => ({}))), this.nzResizeObserver.observe(el)).pipe((0, import_operators.throttleTime)(NZ_AFFIX_DEFAULT_SCROLL_TIME, void 0, {
      trailing: true
    }), (0, import_operators.takeUntil)(this.destroy$)).subscribe((e) => this.updatePosition(e)));
...
//# sourceMappingURL=chunk-JNVXXGOB.js.map
