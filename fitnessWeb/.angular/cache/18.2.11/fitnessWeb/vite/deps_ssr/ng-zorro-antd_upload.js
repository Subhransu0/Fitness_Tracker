...
var NzUploadBtnComponent = class _NzUploadBtnComponent {
  ...
  uploadFiles(fileList) {
    let filters$ = (0, import_rxjs.of)(Array.prototype.slice.call(fileList));
    if (this.options.filters) {
      this.options.filters.forEach((f) => {
        filters$ = filters$.pipe((0, import_operators.switchMap)((list) => {
          const fnRes = f.fn(list);
          return fnRes instanceof import_rxjs.Observable ? fnRes : (0, import_rxjs.of)(fnRes);
        }));
      });
    }
  ...
  upload(file, fileList) {
    ...
    if (before instanceof import_rxjs.Observable) {
  ...
  post(file) {
    ...
    let process$ = (0, import_rxjs.of)(file);
    let transformedFile;
    ...
    if (typeof action === "function") {
      ...
      if (actionResult instanceof import_rxjs.Observable) {
        process$ = process$.pipe((0, import_operators.switchMap)(() => actionResult), (0, import_operators.map)((res) => {
          args.action = res;
          return file;
        }));
      } else {
    ...
    if (typeof transformFile === "function") {
      ...
      process$ = process$.pipe((0, import_operators.switchMap)(() => transformResult instanceof import_rxjs.Observable ? transformResult : (0, import_rxjs.of)(transformResult)), (0, import_operators.tap)((newFile) => transformedFile = newFile));
    }
    if (typeof data === "function") {
      const dataResult = data(file);
      if (dataResult instanceof import_rxjs.Observable) {
        process$ = process$.pipe((0, import_operators.switchMap)(() => dataResult), (0, import_operators.map)((res) => {
          args.data = res;
    ...
    if (typeof headers === "function") {
      ...
      if (headersResult instanceof import_rxjs.Observable) {
        process$ = process$.pipe((0, import_operators.switchMap)(() => headersResult), (0, import_operators.map)((res) => {
          args.headers = res;
          return transformedFile ?? file;
        }));
      } else {
    ...
    process$.subscribe((newFile) => {
      ...
      if (!(req$ instanceof import_rxjs.Subscription)) {
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs.fromEvent)(this.elementRef.nativeElement, "click").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => this.onClick());
      (0, import_rxjs.fromEvent)(this.elementRef.nativeElement, "keydown").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
        if (this.options.disabled) {
          return;
        }
...
var NzUploadListComponent = class _NzUploadListComponent {
  ...
  previewImage(file) {
    ...
    img.src = objectUrl;
    return (0, import_rxjs.fromEvent)(img, "load").pipe((0, import_operators.map)(() => {
      const {
        width,
        height
      } = img;
  ...
  genThumb() {
    ...
    this.list.filter((file) => file.originFileObj instanceof File && file.thumbUrl === void 0).forEach((file) => {
      file.thumbUrl = "";
      const dataUrl$ = (this.previewFile ? this.previewFile(file) : this.previewImage(file.originFileObj)).pipe((0, import_operators.takeUntil)(this.destroy$));
      this.ngZone.runOutsideAngular(() => {
...
var NzUploadComponent = class _NzUploadComponent {
  ...
  constructor(ngZone, cdr, i18n, directionality) {
    ...
    this.onRemove = (file) => {
      ...
      (fnRes instanceof import_rxjs.Observable ? fnRes : (0, import_rxjs.of)(fnRes)).pipe((0, import_operators.filter)((res) => res)).subscribe(() => {
  ...
  ngAfterViewInit() {
    if (this.platform.FIREFOX) {
      this.ngZone.runOutsideAngular(() => (0, import_rxjs.fromEvent)(this.document.body, "drop").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
