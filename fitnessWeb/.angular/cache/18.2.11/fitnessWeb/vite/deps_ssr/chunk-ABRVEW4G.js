...
var DatePickerService = class _DatePickerService {
  constructor() {
    ...
    this.arrowLeft = 0;
    this.isRange = false;
    this.valueChange$ = new import_rxjs.ReplaySubject(1);
    this.emitValue$ = new import_rxjs.Subject();
    this.inputPartChange$ = new import_rxjs.Subject();
  }
...
var DateRangePopupComponent = class _DateRangePopupComponent {
  ...
  ngOnInit() {
    (0, import_rxjs.merge)(this.datePickerService.valueChange$, this.datePickerService.inputPartChange$).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      this.updateActiveDate();
      this.cdr.markForCheck();
    });
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs.fromEvent)(this.host.nativeElement, "mousedown").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => event.preventDefault());
    });
  }
  ngOnChanges(changes) {
...
var NzDatePickerComponent = class _NzDatePickerComponent {
  ...
  ngAfterViewInit() {
    ...
    if (this.isRange && this.platform.isBrowser) {
      this.nzResizeObserver.observe(this.elementRef).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
        this.updateInputWidthAndArrowLeft();
      });
    }
    this.datePickerService.inputPartChange$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((partType) => {
      if (partType) {
    ...
    if (this.platform.isBrowser) {
      this.ngZone.runOutsideAngular(() => (
        ...
        (0, import_rxjs.fromEvent)(this.elementRef.nativeElement, "mousedown").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
  ...
  ngOnInit() {
    ...
    if (!this.nzLocale) {
      this.i18n.localeChange.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => this.setLocale());
    }
    this.datePickerService.isRange = this.isRange;
    this.datePickerService.initValue(true);
    this.datePickerService.emitValue$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
    ...
    this.datePickerService.valueChange$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      this.updateInputValue();
    });
  }
  ngOnChanges(changes) {
...
//# sourceMappingURL=chunk-ABRVEW4G.js.map
