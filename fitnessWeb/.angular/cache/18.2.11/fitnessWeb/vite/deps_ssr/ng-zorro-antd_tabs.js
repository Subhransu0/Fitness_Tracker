...
var NzTabScrollListDirective = class _NzTabScrollListDirective {
  ...
  ngOnInit() {
    this.unsubscribe = this.ngZone.runOutsideAngular(() => {
      ...
      const wheel$ = (0, import_rxjs.fromEvent)(el, "wheel");
      const touchstart$ = (0, import_rxjs.fromEvent)(el, "touchstart");
      const touchmove$ = (0, import_rxjs.fromEvent)(el, "touchmove");
      const touchend$ = (0, import_rxjs.fromEvent)(el, "touchend");
...
var RESIZE_SCHEDULER = typeof requestAnimationFrame !== "undefined" ? import_rxjs.animationFrameScheduler : import_rxjs.asapScheduler;
...
var NzTabNavBarComponent = class _NzTabNavBarComponent {
  ...
  ngAfterViewInit() {
    const dirChange = this.dir ? this.dir.change.asObservable() : (0, import_rxjs.of)(null);
    ...
    (0, import_rxjs.merge)(this.nzResizeObserver.observe(this.navWarpRef), this.nzResizeObserver.observe(this.navListRef)).pipe((0, import_operators.takeUntil)(this.destroy$), (0, import_operators.auditTime)(16, RESIZE_SCHEDULER)).subscribe(() => {
      realign();
    });
    (0, import_rxjs.merge)(dirChange, resize, this.items.changes).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      Promise.resolve().then(realign);
      this.keyManager.withHorizontalOrientation(this.getLayoutDirection());
    });
    this.keyManager.change.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((newFocusIndex) => {
...
var NzTabSetComponent = class _NzTabSetComponent {
  ...
  constructor(nzConfigService, ngZone, cdr, directionality) {
    ...
    this.tabLabelSubscription = import_rxjs.Subscription.EMPTY;
    this.tabsSubscription = import_rxjs.Subscription.EMPTY;
    this.canDeactivateSubscription = import_rxjs.Subscription.EMPTY;
  ...
  subscribeToTabLabels() {
    ...
    this.tabLabelSubscription = (0, import_rxjs.merge)(...this.tabs.map((tab) => tab.stateChanges)).subscribe(() => this.cdr.markForCheck());
  }
  subscribeToAllTabChanges() {
    this.allTabs.changes.pipe((0, import_operators.startWith)(this.allTabs)).subscribe((tabs) => {
  ...
  canDeactivateFun(pre, next) {
    if (typeof this.nzCanDeactivate === "function") {
      ...
      return observable.pipe((0, import_operators.first)(), (0, import_operators.takeUntil)(this.destroy$));
    } else {
  ...
  setUpRouter() {
    if (this.nzLinkRouter) {
      ...
      this.router.events.pipe((0, import_operators.takeUntil)(this.destroy$), (0, import_operators.filter)((e) => e instanceof NavigationEnd), (0, import_operators.startWith)(true), (0, import_operators.delay)(0)).subscribe(() => {
