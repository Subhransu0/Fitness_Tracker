...
import {
  ...
  NzPaginationModule
} from "./chunk-JLGKRW2B.js";
import {
  NzSpinComponent
} from "./chunk-V6HE3CCO.js";
import "./chunk-KQQS32TB.js";
import {
  NzRadioComponent
} from "./chunk-BJ6EFY3J.js";
import {
  NzEmbedEmptyComponent,
  NzEmptyModule
} from "./chunk-ZR2MTL44.js";
import {
  NzI18nService
...
import {
  NzCheckboxComponent,
  NzCheckboxModule
} from "./chunk-CGHJMJOL.js";
import "./chunk-GDWEDULS.js";
import "./chunk-2AJM3INJ.js";
import {
  NzDropDownDirective,
  NzDropDownModule,
...
import {
  NzMenuDirective,
  NzMenuItemComponent
} from "./chunk-JN5TZ3HJ.js";
import {
  NzButtonComponent,
  NzButtonModule
} from "./chunk-AJKXIHRQ.js";
import {
  NzWaveDirective
} from "./chunk-YNKORDG6.js";
import {
  NzTransitionPatchDirective
} from "./chunk-73RX5EWJ.js";
import "./chunk-F3RBYOAN.js";
import "./chunk-2B2PPL6U.js";
...
var NzFilterTriggerComponent = class _NzFilterTriggerComponent {
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs.fromEvent)(this.nzDropdown.nativeElement, "click").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
...
var NzTableStyleService = class _NzTableStyleService {
  constructor() {
    this.theadTemplate$ = new import_rxjs.ReplaySubject(1);
    this.tfootTemplate$ = new import_rxjs.ReplaySubject(1);
    this.tfootFixed$ = new import_rxjs.ReplaySubject(1);
    this.hasFixLeft$ = new import_rxjs.ReplaySubject(1);
    this.hasFixRight$ = new import_rxjs.ReplaySubject(1);
    this.hostWidth$ = new import_rxjs.ReplaySubject(1);
    this.columnCount$ = new import_rxjs.ReplaySubject(1);
    this.showEmpty$ = new import_rxjs.ReplaySubject(1);
    this.noResult$ = new import_rxjs.ReplaySubject(1);
    this.listOfThWidthConfigPx$ = new import_rxjs.BehaviorSubject([]);
    this.tableWidthConfigPx$ = new import_rxjs.BehaviorSubject([]);
    this.manualWidthConfigPx$ = (0, import_rxjs.combineLatest)([this.tableWidthConfigPx$, this.listOfThWidthConfigPx$]).pipe((0, import_operators.map)(([widthConfig, listOfWidth]) => widthConfig.length ? widthConfig : listOfWidth));
    this.listOfAutoWidthPx$ = new import_rxjs.ReplaySubject(1);
    this.listOfListOfThWidthPx$ = (0, import_rxjs.merge)(
      /** init with manual width **/
      this.manualWidthConfigPx$,
      (0, import_rxjs.combineLatest)([this.listOfAutoWidthPx$, this.manualWidthConfigPx$]).pipe((0, import_operators.map)(([autoWidth, manualWidth]) => {
    ...
    this.listOfMeasureColumn$ = new import_rxjs.ReplaySubject(1);
    this.listOfListOfThWidth$ = this.listOfAutoWidthPx$.pipe((0, import_operators.map)((list) => list.map((width) => parseInt(width, 10))));
    this.enableAutoMeasure$ = new import_rxjs.ReplaySubject(1);
  }
...
var NzTableDataService = class _NzTableDataService {
  ...
  constructor() {
    this.destroy$ = new import_rxjs.Subject();
    this.pageIndex$ = new import_rxjs.BehaviorSubject(1);
    this.frontPagination$ = new import_rxjs.BehaviorSubject(true);
    this.pageSize$ = new import_rxjs.BehaviorSubject(10);
    this.listOfData$ = new import_rxjs.BehaviorSubject([]);
    this.listOfCustomColumn$ = new import_rxjs.BehaviorSubject([]);
    this.pageIndexDistinct$ = this.pageIndex$.pipe((0, import_operators.distinctUntilChanged)());
    this.pageSizeDistinct$ = this.pageSize$.pipe((0, import_operators.distinctUntilChanged)());
    this.listOfCalcOperator$ = new import_rxjs.BehaviorSubject([]);
    this.queryParams$ = (0, import_rxjs.combineLatest)([this.pageIndexDistinct$, this.pageSizeDistinct$, this.listOfCalcOperator$]).pipe((0, import_operators.debounceTime)(0), (0, import_operators.skip)(1), (0, import_operators.map)(([pageIndex, pageSize, listOfCalc]) => ({
      pageIndex,
      pageSize,
    ...
    this.listOfDataAfterCalc$ = (0, import_rxjs.combineLatest)([this.listOfData$, this.listOfCalcOperator$]).pipe((0, import_operators.map)(([listOfData, listOfCalcOperator]) => {
    ...
    this.listOfFrontEndCurrentPageData$ = (0, import_rxjs.combineLatest)([this.pageIndexDistinct$, this.pageSizeDistinct$, this.listOfDataAfterCalc$]).pipe((0, import_operators.takeUntil)(this.destroy$), (0, import_operators.filter)((value) => {
      const [pageIndex, pageSize, listOfData] = value;
      const maxPageIndex = Math.ceil(listOfData.length / pageSize) || 1;
      return pageIndex <= maxPageIndex;
    }), (0, import_operators.map)(([pageIndex, pageSize, listOfData]) => listOfData.slice((pageIndex - 1) * pageSize, pageIndex * pageSize)));
    this.listOfCurrentPageData$ = this.frontPagination$.pipe((0, import_operators.switchMap)((pagination) => pagination ? this.listOfFrontEndCurrentPageData$ : this.listOfDataAfterCalc$));
    this.total$ = this.frontPagination$.pipe((0, import_operators.switchMap)((pagination) => pagination ? this.listOfDataAfterCalc$ : this.listOfData$), (0, import_operators.map)((list) => list.length), (0, import_operators.distinctUntilChanged)());
  }
  ngOnDestroy() {
    this.destroy$.next(true);
    this.destroy$.complete();
...
var NzCustomColumnDirective = class _NzCustomColumnDirective {
  ...
  ngOnInit() {
    this.nzTableDataService.listOfCustomColumn$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((item) => {
      if (item.length) {
        item.forEach((v, i) => {
...
var NzThAddOnComponent = class _NzThAddOnComponent {
  ...
  constructor(host, cdr, ngZone, destroy$) {
    ...
    this.ngZone = ngZone;
    this.destroy$ = destroy$;
    this.manualClickOrder$ = new import_rxjs.Subject();
    this.calcOperatorChange$ = new import_rxjs.Subject();
    this.nzFilterValue = null;
    this.sortOrder = null;
    this.sortDirections = ["ascend", "descend", null];
    this.sortOrderChange$ = new import_rxjs.Subject();
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => (0, import_rxjs.fromEvent)(this.host.nativeElement, "click").pipe((0, import_operators.filter)(() => this.nzShowSort), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
    ...
    this.sortOrderChange$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((order) => {
...
var NzTableFixedRowComponent = class _NzTableFixedRowComponent {
  constructor(nzTableStyleService, renderer) {
    ...
    this.renderer = renderer;
    this.hostWidth$ = new import_rxjs.BehaviorSubject(null);
    this.enableAutoMeasure$ = new import_rxjs.BehaviorSubject(false);
    this.destroy$ = new import_rxjs.Subject();
  }
  ngOnInit() {
    if (this.nzTableStyleService) {
      ...
      enableAutoMeasure$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(this.enableAutoMeasure$);
      hostWidth$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(this.hostWidth$);
    }
  }
  ngAfterViewInit() {
    this.nzTableStyleService.columnCount$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((count) => {
...
var NzTrMeasureComponent = class _NzTrMeasureComponent {
  ...
  ngAfterViewInit() {
    this.listOfTdElement.changes.pipe((0, import_operators.startWith)(this.listOfTdElement)).pipe((0, import_operators.switchMap)((list) => (0, import_rxjs.combineLatest)(list.toArray().map((item) => this.nzResizeObserver.observe(item).pipe((0, import_operators.map)(([entry]) => {
      const {
        width
      } = entry.target.getBoundingClientRect();
      return Math.floor(width);
    }))))), (0, import_operators.debounceTime)(16), (0, import_operators.takeUntil)(this.destroy$)).subscribe((data) => {
...
var NzTbodyComponent = class _NzTbodyComponent {
  constructor() {
    ...
    this.showEmpty$ = new import_rxjs.BehaviorSubject(false);
    this.noResult$ = new import_rxjs.BehaviorSubject(void 0);
    this.listOfMeasureColumn$ = new import_rxjs.BehaviorSubject([]);
    this.destroy$ = new import_rxjs.Subject();
    ...
    if (this.nzTableStyleService) {
      ...
      noResult$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(this.noResult$);
      listOfMeasureColumn$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(this.listOfMeasureColumn$);
      showEmpty$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(this.showEmpty$);
    }
  }
...
var NzTableInnerScrollComponent = class _NzTableInnerScrollComponent {
  ...
  constructor(renderer, ngZone, platform, resizeService) {
    ...
    this.data$ = new import_rxjs.Subject();
  ...
  ngAfterViewInit() {
    if (this.platform.isBrowser) {
      this.ngZone.runOutsideAngular(() => {
        const scrollEvent$ = this.scroll$.pipe((0, import_operators.startWith)(null), (0, import_operators.delay)(0), (0, import_operators.switchMap)(() => (0, import_rxjs.fromEvent)(this.tableBodyElement.nativeElement, "scroll").pipe((0, import_operators.startWith)(true))), (0, import_operators.takeUntil)(this.destroy$));
        const resize$ = this.resizeService.subscribe().pipe((0, import_operators.takeUntil)(this.destroy$));
        const data$ = this.data$.pipe((0, import_operators.takeUntil)(this.destroy$));
        const setClassName$ = (0, import_rxjs.merge)(scrollEvent$, resize$, data$, this.scroll$).pipe((0, import_operators.startWith)(true), (0, import_operators.delay)(0), (0, import_operators.takeUntil)(this.destroy$));
        setClassName$.subscribe(() => this.setScrollPositionClassName());
        scrollEvent$.pipe((0, import_operators.filter)(() => !!this.scrollY)).subscribe(() => {
...
var NzTableComponent = class _NzTableComponent {
  ...
  constructor(elementRef, nzResizeObserver, nzConfigService, cdr, nzTableStyleService, nzTableDataService, directionality) {
    ...
    this.destroy$ = new import_rxjs.Subject();
    this.templateMode$ = new import_rxjs.BehaviorSubject(false);
    this.dir = "ltr";
    this.verticalScrollBarWidth = 0;
  ...
  ngOnInit() {
    ...
    queryParams$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(this.nzQueryParams);
    pageIndexDistinct$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((pageIndex) => {
      if (pageIndex !== this.nzPageIndex) {
        this.nzPageIndex = pageIndex;
        this.nzPageIndexChange.next(pageIndex);
      }
    });
    pageSizeDistinct$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((pageSize) => {
      if (pageSize !== this.nzPageSize) {
        this.nzPageSize = pageSize;
        this.nzPageSizeChange.next(pageSize);
      }
    });
    total$.pipe((0, import_operators.takeUntil)(this.destroy$), (0, import_operators.filter)(() => this.nzFrontPagination)).subscribe((total) => {
      if (total !== this.nzTotal) {
        this.nzTotal = total;
        this.cdr.markForCheck();
      }
    });
    listOfCurrentPageData$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((data) => {
      this.data = data;
      this.nzCurrentPageDataChange.next(data);
      this.cdr.markForCheck();
    });
    listOfCustomColumn$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((data) => {
      this.nzCustomColumn = data;
      this.nzCustomColumnChange.next(data);
      this.cdr.markForCheck();
    });
    theadTemplate$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((theadTemplate) => {
      this.theadTemplate = theadTemplate;
      this.cdr.markForCheck();
    });
    (0, import_rxjs.combineLatest)([tfootTemplate$, tfootFixed$]).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(([tfootTemplate, tfootFixed]) => {
      this.tfootTemplate = tfootTemplate;
      this.tfootFixed = tfootFixed;
      this.cdr.markForCheck();
    });
    hasFixLeft$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((hasFixLeft) => {
      this.hasFixLeft = hasFixLeft;
      this.cdr.markForCheck();
    });
    hasFixRight$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((hasFixRight) => {
      this.hasFixRight = hasFixRight;
      this.cdr.markForCheck();
    });
    (0, import_rxjs.combineLatest)([total$, this.templateMode$]).pipe((0, import_operators.map)(([total, templateMode]) => total === 0 && !templateMode), (0, import_operators.takeUntil)(this.destroy$)).subscribe((empty) => {
      this.nzTableStyleService.setShowEmpty(empty);
    });
    this.verticalScrollBarWidth = measureScrollbar("vertical");
    this.nzTableStyleService.listOfListOfThWidthPx$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((listOfWidth) => {
      this.listOfAutoColWidth = listOfWidth;
      this.cdr.markForCheck();
    });
    this.nzTableStyleService.manualWidthConfigPx$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((listOfWidth) => {
  ...
  ngAfterViewInit() {
    this.nzResizeObserver.observe(this.elementRef).pipe((0, import_operators.map)(([entry]) => {
      const {
        width
      } = entry.target.getBoundingClientRect();
      const scrollBarWidth = this.scrollY ? this.verticalScrollBarWidth : 0;
      return Math.floor(width - scrollBarWidth);
    }), (0, import_operators.takeUntil)(this.destroy$)).subscribe(this.nzTableStyleService.hostWidth$);
...
var NzTrDirective = class _NzTrDirective {
  constructor() {
    this.destroy$ = new import_rxjs.Subject();
    this.listOfFixedColumns$ = new import_rxjs.ReplaySubject(1);
    this.listOfColumns$ = new import_rxjs.ReplaySubject(1);
    this.listOfFixedColumnsChanges$ = this.listOfFixedColumns$.pipe((0, import_operators.switchMap)((list) => (0, import_rxjs.merge)(...[this.listOfFixedColumns$, ...list.map((c) => c.changes$)]).pipe((0, import_operators.mergeMap)(() => this.listOfFixedColumns$))), (0, import_operators.takeUntil)(this.destroy$));
    this.listOfFixedLeftColumnChanges$ = this.listOfFixedColumnsChanges$.pipe((0, import_operators.map)((list) => list.filter((item) => item.nzLeft !== false)));
    this.listOfFixedRightColumnChanges$ = this.listOfFixedColumnsChanges$.pipe((0, import_operators.map)((list) => list.filter((item) => item.nzRight !== false)));
    this.listOfColumnsChanges$ = this.listOfColumns$.pipe((0, import_operators.switchMap)((list) => (0, import_rxjs.merge)(...[this.listOfColumns$, ...list.map((c) => c.changes$)]).pipe((0, import_operators.mergeMap)(() => this.listOfColumns$))), (0, import_operators.takeUntil)(this.destroy$));
    this.nzTableStyleService = inject(NzTableStyleService, {
      optional: true
    });
    this.isInsideTable = !!this.nzTableStyleService;
  ...
  ngAfterContentInit() {
    if (this.nzTableStyleService) {
      this.listOfCellFixedDirective.changes.pipe((0, import_operators.startWith)(this.listOfCellFixedDirective), (0, import_operators.takeUntil)(this.destroy$)).subscribe(this.listOfFixedColumns$);
      this.listOfNzThDirective.changes.pipe((0, import_operators.startWith)(this.listOfNzThDirective), (0, import_operators.takeUntil)(this.destroy$)).subscribe(this.listOfColumns$);
      ...
      (0, import_rxjs.combineLatest)([this.nzTableStyleService.listOfListOfThWidth$, this.listOfFixedLeftColumnChanges$]).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(([listOfAutoWidth, listOfLeftCell]) => {
      ...
      (0, import_rxjs.combineLatest)([this.nzTableStyleService.listOfListOfThWidth$, this.listOfFixedRightColumnChanges$]).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(([listOfAutoWidth, listOfRightCell]) => {
...
var NzTheadComponent = class _NzTheadComponent {
  ...
  ngAfterContentInit() {
    if (this.nzTableStyleService) {
      const firstTableRow$ = this.listOfNzTrDirective.changes.pipe((0, import_operators.startWith)(this.listOfNzTrDirective), (0, import_operators.map)((item) => item && item.first));
      const listOfColumnsChanges$ = firstTableRow$.pipe((0, import_operators.switchMap)((firstTableRow) => firstTableRow ? firstTableRow.listOfColumnsChanges$ : import_rxjs.EMPTY), (0, import_operators.takeUntil)(this.destroy$));
      listOfColumnsChanges$.subscribe((data) => this.nzTableStyleService.setListOfTh(data));
      this.nzTableStyleService.enableAutoMeasure$.pipe((0, import_operators.switchMap)((enable) => enable ? listOfColumnsChanges$ : (0, import_rxjs.of)([]))).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((data) => this.nzTableStyleService.setListOfMeasureColumn(data));
      const listOfFixedLeftColumnChanges$ = firstTableRow$.pipe((0, import_operators.switchMap)((firstTr) => firstTr ? firstTr.listOfFixedLeftColumnChanges$ : import_rxjs.EMPTY), (0, import_operators.takeUntil)(this.destroy$));
      const listOfFixedRightColumnChanges$ = firstTableRow$.pipe((0, import_operators.switchMap)((firstTr) => firstTr ? firstTr.listOfFixedRightColumnChanges$ : import_rxjs.EMPTY), (0, import_operators.takeUntil)(this.destroy$));
    ...
    if (this.nzTableDataService) {
      const listOfColumn$ = this.listOfNzThAddOnComponent.changes.pipe((0, import_operators.startWith)(this.listOfNzThAddOnComponent));
      const manualSort$ = listOfColumn$.pipe((0, import_operators.switchMap)(() => (0, import_rxjs.merge)(...this.listOfNzThAddOnComponent.map((th) => th.manualClickOrder$))), (0, import_operators.takeUntil)(this.destroy$));
      ...
      const listOfCalcOperator$ = listOfColumn$.pipe(
        (0, import_operators.switchMap)((list) => (0, import_rxjs.merge)(...[listOfColumn$, ...list.map((c) => c.calcOperatorChange$)]).pipe((0, import_operators.mergeMap)(() => listOfColumn$))),
        (0, import_operators.map)((list) => list.filter((item) => !!item.nzSortFn || !!item.nzFilterFn).map((item) => {
          const {
            nzSortFn,
            sortOrder,
            nzFilterFn,
