...
var NzImagePreviewComponent = class _NzImagePreviewComponent {
  ...
  ngOnInit() {
    this.ngZone.runOutsideAngular(() => {
      (0, import_rxjs.fromEvent)(this.imagePreviewWrapper.nativeElement, "mousedown").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
        this.isDragging = true;
      });
      (0, import_rxjs.fromEvent)(this.imagePreviewWrapper.nativeElement, "wheel").pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
...
var NzImagePreviewRef = class {
  constructor(previewInstance, config, overlayRef) {
    ...
    overlayRef.keydownEvents().pipe((0, import_operators.filter)((event) => this.config.nzKeyboard && (event.keyCode === ESCAPE || event.keyCode === LEFT_ARROW || event.keyCode === RIGHT_ARROW) && !hasModifierKey(event))).subscribe((event) => {
      event.preventDefault();
    ...
    previewInstance.closeClick.pipe((0, import_operators.take)(1), (0, import_operators.switchMap)(() => previewInstance.animationStateChanged), (0, import_operators.filter)((event) => event.phaseName === "done"), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      this.close();
    });
  }
  switchTo(index) {
...
var NzImageDirective = class _NzImageDirective {
  ...
  constructor(nzConfigService, elementRef, nzImageService, cdr, directionality) {
    ...
    this.nzScaleStep = null;
    this.status = "normal";
    this.backLoadDestroy$ = new import_rxjs.Subject();
    this.destroy$ = new import_rxjs.Subject();
  ...
  backLoad() {
    ...
    if (this.backLoadImage.complete) {
      ...
      (0, import_rxjs.fromEvent)(this.backLoadImage, "load").pipe((0, import_operators.takeUntil)(this.backLoadDestroy$), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
        this.status = "normal";
        this.getElement().nativeElement.src = this.nzSrc;
        this.getElement().nativeElement.srcset = this.nzSrcset;
      });
      (0, import_rxjs.fromEvent)(this.backLoadImage, "error").pipe((0, import_operators.takeUntil)(this.backLoadDestroy$), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
        this.status = "error";
        if (this.nzFallback) {
  ...
  static {
    this.ɵfac = function NzImageDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _NzImageDirective)(ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NzImageService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(Directionality));
    };
  }
  static {
