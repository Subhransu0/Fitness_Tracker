...
var NzSliderComponent = class _NzSliderComponent {
  ...
  bindDraggingHandlers() {
    ...
    [mouse, touch].forEach((source) => {
      ...
      source.startPlucked$ = (0, import_rxjs.fromEvent)(sliderDOM, start).pipe((0, import_operators.filter)(filterFunc), (0, import_operators.tap)(silentEvent), (0, import_operators.map)(pluckFunc(pluckKey)), (0, import_operators.map)((position) => this.findClosestValue(position)));
      source.end$ = (0, import_rxjs.fromEvent)(document, end);
      source.moveResolved$ = (0, import_rxjs.fromEvent)(document, move).pipe((0, import_operators.filter)(filterFunc), (0, import_operators.tap)(silentEvent), (0, import_operators.map)(pluckFunc(pluckKey)), (0, import_operators.distinctUntilChanged)(), (0, import_operators.map)((position) => this.findClosestValue(position)), (0, import_operators.distinctUntilChanged)(), (0, import_operators.takeUntil)(source.end$));
    });
    this.dragStart$ = (0, import_rxjs.merge)(mouse.startPlucked$, touch.startPlucked$);
    this.dragMove$ = (0, import_rxjs.merge)(mouse.moveResolved$, touch.moveResolved$);
    this.dragEnd$ = (0, import_rxjs.merge)(mouse.end$, touch.end$);
  }
