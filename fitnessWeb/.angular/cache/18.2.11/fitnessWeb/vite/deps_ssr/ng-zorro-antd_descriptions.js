...
var NzDescriptionsItemComponent = class _NzDescriptionsItemComponent {
  constructor() {
    this.nzSpan = 1;
    this.nzTitle = "";
    this.inputChange$ = new import_rxjs.Subject();
  }
  ngOnChanges() {
...
var NzDescriptionsComponent = class _NzDescriptionsComponent {
  ...
  ngAfterContentInit() {
    const contentChange$ = this.items.changes.pipe((0, import_operators.startWith)(this.items), (0, import_operators.takeUntil)(this.destroy$));
    (0, import_rxjs.merge)(contentChange$, contentChange$.pipe((0, import_operators.switchMap)(() => (0, import_rxjs.merge)(...this.items.map((i) => i.inputChange$)).pipe((0, import_operators.auditTime)(16)))), this.breakpointService.subscribe(gridResponsiveMap).pipe((0, import_operators.tap)((bp) => this.breakpoint = bp))).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      this.prepareMatrix();
