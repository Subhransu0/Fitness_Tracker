...
var NzCollapseComponent = class _NzCollapseComponent {
  constructor(nzConfigService, cdr, directionality, destroy$) {
    ...
    this.nzConfigService.getConfigChangeEventForComponent(NZ_CONFIG_MODULE_NAME$1).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
...
var NzCollapsePanelComponent = class _NzCollapsePanelComponent {
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => (0, import_rxjs.fromEvent)(this.collapseHeader.nativeElement, "click").pipe((0, import_operators.filter)(() => !this.nzDisabled), (0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
      this.ngZone.run(() => {
