...
} from "./chunk-KQQS32TB.js";
import "./chunk-MLCO7F2U.js";
import {
  NzEmbedEmptyComponent,
  NzEmptyModule
} from "./chunk-ZR2MTL44.js";
import "./chunk-5VNJEEWL.js";
...
var NzTreeSelectComponent = class _NzTreeSelectComponent extends NzTreeBase {
  ...
  constructor(nzTreeService, nzConfigService, renderer, cdr, elementRef, directionality, focusMonitor) {
    ...
    this.isComposingChange$ = new import_rxjs.Subject();
    this.searchValueChange$ = new import_rxjs.Subject();
  ...
  ngOnInit() {
    ...
    (0, import_rxjs.combineLatest)([this.searchValueChange$, this.isComposingChange$.pipe((0, import_operators.startWith)(false))]).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(([searchValue, isComposing]) => {
  ...
  subscribeSelectionChange() {
    (0, import_rxjs.merge)(this.nzTreeClick.pipe((0, import_operators.tap)((event) => {
    ...
    }), (0, import_operators.filter)((event) => {
      const node = event.node;
      return this.nzCheckable ? !node.isDisabled && !node.isDisableCheckbox : !node.isDisabled && node.isSelectable;
    })), this.nzCheckable ? this.nzTreeCheckBoxChange.asObservable() : (0, import_rxjs.of)(), this.nzCleared, this.nzRemoved).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe(() => {
