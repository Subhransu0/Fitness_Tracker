...
var NzPageHeaderComponent = class _NzPageHeaderComponent {
  ...
  ngAfterViewInit() {
    this.nzResizeObserver.observe(this.elementRef).pipe((0, import_operators.map)(([entry]) => entry.contentRect.width), (0, import_operators.takeUntil)(this.destroy$)).subscribe((width) => {
