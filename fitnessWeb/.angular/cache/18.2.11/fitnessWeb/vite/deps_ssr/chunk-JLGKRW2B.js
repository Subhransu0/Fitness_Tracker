...
var NzPaginationComponent = class _NzPaginationComponent {
  ...
  constructor(i18n, cdr, breakpointService, nzConfigService, directionality) {
    ...
    this.dir = "ltr";
    this.destroy$ = new import_rxjs.Subject();
    this.total$ = new import_rxjs.ReplaySubject(1);
  }
  ngOnInit() {
    ...
    this.total$.pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((total) => {
      this.onTotalChange(total);
    });
    this.breakpointService.subscribe(gridResponsiveMap).pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((bp) => {
...
//# sourceMappingURL=chunk-JLGKRW2B.js.map
