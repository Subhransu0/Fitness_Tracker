...
var NzDrawerComponent = class _NzDrawerComponent extends NzDrawerRef {
  ...
  constructor(cdr, nzConfigService, renderer, overlay, injector, changeDetectorRef, focusTrapFactory, viewContainerRef, overlayKeyboardDispatcher, directionality) {
    ...
    this.nzAfterOpen = new import_rxjs.Subject();
    this.nzAfterClose = new import_rxjs.Subject();
  ...
  attachOverlay() {
    ...
    if (this.overlayRef && !this.overlayRef.hasAttached()) {
      ...
      this.overlayRef.keydownEvents().pipe((0, import_operators.takeUntil)(this.destroy$)).subscribe((event) => {
...
var DrawerBuilderForService = class {
  constructor(overlay, options) {
    ...
    this.drawerRef.nzOnViewInit.pipe((0, import_operators.takeUntil)(this.unsubscribe$)).subscribe(() => {
      this.drawerRef.open();
    });
    ...
    this.drawerRef.afterClose.pipe((0, import_operators.takeUntil)(this.unsubscribe$)).subscribe(() => {
      this.overlayRef.dispose();
      this.drawerRef = null;
